...
<body>
	<s:debug />
	<s:form action="good_add" namespace="/" method="post"
		...
		<table width="500px" cellSpacing="1" cellPadding="5" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="5"
					height="26"><strong>添&nbsp;加&nbsp;商&nbsp;品</strong></td>
			</tr>
			<tr>
				<td bgColor="#f5fafe" class="ta_01">名称：</td>
				<td bgColor="#ffffff" class="ta_01"><s:textfield name="name" /></td>
				<td bgColor="#f5fafe" class="ta_01">价格：</td>
				<td bgColor="#ffffff" class="ta_01"><s:textfield name="price" /></td>
				<td bgColor="#ffffff" class="ta_01"><s:radio
						list="%{#{'1':'热门','0':'冷门'}}" name="isHot" value="0" /></td>
			</tr>
			<tr>
				...
				<td bgColor="#ffffff" class="ta_01"><s:select id="category1"
						...
						headerValue="一级分类" /><span id="category2Span"><select
						name='category2Id'><option value='-1'>二级分类</option></select></span></td>
			...
			<tr>
				...
				<td bgColor="#ffffff" class="ta_01" colspan="4"><s:textarea
						name="description" rows="2" cols="42" /></td>
			</tr>
			<tr align="center">
